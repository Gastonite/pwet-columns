...
/******/ 	var hotCurrentHash = "f0b74fe2d7fdfde0a99e"; // eslint-disable-line no-unused-vars
...
internal.Columns = function (component) {
  ...
  var children = Array.from(element.childNodes).map(element.removeChild.bind(element));

  var initialize = function initialize(newProperties, _initialize) {

    var oldProperties = component.properties;

    newProperties.children = children.filter(_assertions.isElement).reduce(function (children, child, i) {
  ...
  var render = function render() {
    ...
    (0, _incrementalDom.patch)(element, function () {
      ...
      children.forEach(function (children, i) {
        (0, _idomUtil.renderDiv)(i, function () {
          var currentColumn = (0, _incrementalDom.currentElement)();
          children.forEach(function (child, j) {
            (0, _idomUtil.renderDiv)(i + '_' + j, function () {
...
internal.Columns.properties = {
  columns: _attribute2.default.integer()
};
