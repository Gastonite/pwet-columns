...
/******/ 	var hotCurrentHash = "440af5c9648d2e2ee00c"; // eslint-disable-line no-unused-vars
...
internal.Columns = function (component) {
  ...
  var attach = function attach(_attach) {
    ...
    if (properties.children.length < 1) component.initialize({
      children: Array.from(element.childNodes).map(element.removeChild.bind(element)).filter(_assertions.isElement)
    });
  ...
  var initialize = function initialize(newProperties, _initialize) {
    ...
    var columns = newProperties.children.reduce(function (children, child, i) {

      children[i % newProperties.columns].push(child);

      return children;
    }, new Array(newProperties.columns).fill().map(function () {
      return [];
    }));
    ...
    _initialize(component.isAttached && !(0, _assertions.isDeeplyEqual)(properties, newProperties));
  };
  ...
  var render = function render() {
    ...
    var children = properties.children,
        renderColumns = properties.renderColumns;
...
internal.Columns.create = _stateful2.default;
...
internal.Columns.properties = {
  columns: _attribute2.default.integer({ defaultValue: 2 }),
  children: {
    defaultValue: []
  },
  renderColumns: function renderColumns(element, columns) {

    while (element.firstChild) {
      element.removeChild(element.firstChild);
    }columns.forEach(function (children) {

      var columnElement = element.appendChild(document.createElement('div'));

      children.forEach(function (item) {
        return columnElement.appendChild(item);
      });
    });
  }
};
...
exports.default = internal.Columns;
...
var _xColumns = __webpack_require__("../../src/x-columns.js");

var _xColumns2 = _interopRequireDefault(_xColumns);

var _incrementalDom = __webpack_require__("../../node_modules/incremental-dom/dist/incremental-dom-cjs.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_component2.default.define(_xColumns2.default);

var makeBlock = function makeBlock(text) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var columns = document.createElement('x-columns');

  var renderCount = 0;

  // customize the rendering
  columns.renderColumns = function (element, columns) {
    renderCount++;
    (0, _incrementalDom.patch)(element, function () {
      columns.forEach(function (items, i) {
        (0, _incrementalDom.elementOpen)('div', renderCount + '_' + i);
        items.forEach(function (child, j) {
          (0, _incrementalDom.elementOpen)('div', renderCount + '_' + j + '_' + i);
          (0, _incrementalDom.currentElement)().appendChild(child);
  ...
  columns.children = new Array(42).fill().map(function (item, index) {
    return makeBlock(index + 'a');
  });
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      columns.pwet.initialize({
        columns: 4,
        children: new Array(6).fill().map(function (item, index) {
          return makeBlock(index + 'b');
        })
      });
